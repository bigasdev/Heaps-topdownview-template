...
class Game extends Process {
	...
	**/
	...
	public function createItem(x:Int, y:Int, s:String, b:Bool, spd:Float, magnet:Float){
		var i = new BaseItem(x,y,s,b,spd,magnet);
		i.setPosCase(x,y);
	...
	public function createEnemy(x:Int, y:Int, h:Int, s:String){
		var i = new en.Enemy(x,y,h,s);
		i.setPosCase(x,y);
		debug(Std.string("Created + "+s));
		enemies.push(i);
	}
